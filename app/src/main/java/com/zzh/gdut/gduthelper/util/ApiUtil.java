...
public class ApiUtil {
    ...
    public static final String URL_GET_PERSON_INFO = URL_HOST_TWO + "/wsgrxx.aspx";
    //获取个人头像 后面参数 ?xh=3114005890
    public static final String URL_GET_IMAGE_HEAD = URL_HOST_TWO + "/readimagexs.aspx";
}
